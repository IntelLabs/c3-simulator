...
/**
 * @brief Check whether combination of pass-by-reference and pass-by-value values are the same
 * 
 * Use pass-by-reference (i.e., pointer's to values) and pass-by-value and try to ensure 
 * compiler cannot be too clever and optimize away memory ops that may be under test
 * 
 * @tparam Ty 
 */
